...
char* V_strncat(char* pDest, const char* pSrc, size_t cchDest, int max_chars_to_copy = COPY_ALL_CHARACTERS);
...
char* V_strnlwr(char* pBuf, size_t cchBuf);
...
int Q_UTF8ToUTF16(const char* pUTF8, uchar16* pUTF16, int cubDestSizeInBytes, EStringConvertErrorPolicy ePolicy = STRINGCONVERT_ASSERT_REPLACE);
int Q_UTF8ToUTF32(const char* pUTF8, uchar32* pUTF32, int cubDestSizeInBytes, EStringConvertErrorPolicy ePolicy = STRINGCONVERT_ASSERT_REPLACE);
int Q_UTF16ToUTF8(const uchar16* pUTF16, char* pUTF8, int cubDestSizeInBytes, EStringConvertErrorPolicy ePolicy = STRINGCONVERT_ASSERT_REPLACE);
int Q_UTF16ToUTF32(const uchar16* pUTF16, uchar32* pUTF32, int cubDestSizeInBytes, EStringConvertErrorPolicy ePolicy = STRINGCONVERT_ASSERT_REPLACE);
int Q_UTF32ToUTF8(const uchar32* pUTF32, char* pUTF8, int cubDestSizeInBytes, EStringConvertErrorPolicy ePolicy = STRINGCONVERT_ASSERT_REPLACE);
int Q_UTF32ToUTF16(const uchar32* pUTF32, uchar16* pUTF16, int cubDestSizeInBytes, EStringConvertErrorPolicy ePolicy = STRINGCONVERT_ASSERT_REPLACE);

// This is disgusting and exist only easily to facilitate having 16-bit and 32-bit wchar_t's on different platforms
int Q_UTF32ToUTF32(const uchar32* pUTF32Source, uchar32* pUTF32Dest, int cubDestSizeInBytes, EStringConvertErrorPolicy ePolicy = STRINGCONVERT_ASSERT_REPLACE);
...
// Returns the number of bytes written to the output, or if output is NULL, the number of bytes required.
int Q_UTF8CharsToUTF16(const char* pUTF8, int nElements, uchar16* pUTF16, int cubDestSizeInBytes, EStringConvertErrorPolicy ePolicy = STRINGCONVERT_ASSERT_REPLACE);
int Q_UTF8CharsToUTF32(const char* pUTF8, int nElements, uchar32* pUTF32, int cubDestSizeInBytes, EStringConvertErrorPolicy ePolicy = STRINGCONVERT_ASSERT_REPLACE);
int Q_UTF16CharsToUTF8(const uchar16* pUTF16, int nElements, char* pUTF8, int cubDestSizeInBytes, EStringConvertErrorPolicy ePolicy = STRINGCONVERT_ASSERT_REPLACE);
int Q_UTF16CharsToUTF32(const uchar16* pUTF16, int nElements, uchar32* pUTF32, int cubDestSizeInBytes, EStringConvertErrorPolicy ePolicy = STRINGCONVERT_ASSERT_REPLACE);
int Q_UTF32CharsToUTF8(const uchar32* pUTF32, int nElements, char* pUTF8, int cubDestSizeInBytes, EStringConvertErrorPolicy ePolicy = STRINGCONVERT_ASSERT_REPLACE);
int Q_UTF32CharsToUTF16(const uchar32* pUTF32, int nElements, uchar16* pUTF16, int cubDestSizeInBytes, EStringConvertErrorPolicy ePolicy = STRINGCONVERT_ASSERT_REPLACE);
...
int Q_LocaleSpecificANSIToUTF8(const char* pANSI, int cubSrcInBytes, char* pUTF8, int cubDestSizeInBytes);
#endif
...
int Q_Windows1252CharsToUTF8(const char* pchSrc, int cchSrc, char* pchDestUTF8, int cchDestUTF8);
...
int Q_CP437CharsToUTF8(const char* pchSrc, int cchSrc, char* pchDestUTF8, int cchDestUTF8);
...
int Q_NormalizeUTF8Old(const char* pchSrc, char* pchDest, int cchDest);
int Q_NormalizeUTF8(const char* pchSrc, char* pchDest, int cchDest);
...
int V_vsnwprintf(wchar_t* pDest, int maxLenInCharacters, const wchar_t* pFormat, va_list params);
...
int V_vsnprintfRet(char* pDest, int maxLenInCharacters, const char* pFormat, va_list params, bool* pbTruncated);
...
int V_snwprintf(wchar_t* pDest, int maxLenInCharacters, const wchar_t* pFormat, ...);
...
bool V_StrSubst(const char* pIn, const char* pMatch, const char* pReplaceWith, char* pOut, int outLen, bool bCaseSensitive = false);
...
void V_wcstostr(const wchar_t* pWString, int nInSize, char* pString, int nOutSizeInBytes);
