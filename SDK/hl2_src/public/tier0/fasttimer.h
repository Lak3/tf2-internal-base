...
inline uint64 g_ClockSpeed;
#if defined( _X360 ) && defined( _CERT )
PLATFORM_INTERFACE unsigned long g_dwFakeFastCounter;
#endif

inline double g_ClockSpeedMicrosecondsMultiplier;
inline double g_ClockSpeedMillisecondsMultiplier;
inline double g_ClockSpeedSecondsMultiplier;
