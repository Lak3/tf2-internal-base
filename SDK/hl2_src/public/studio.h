...
public:
	...
	public:
		...
		struct HashValueType
		{
			...
			{
				Warning("Don't use default HashValueType()!");
			}
...
{
	//put this to make sure this code is updated upon changing version.
	if (STUDIO_VERSION != 48)
		Warning(L"STUDIO_VERSION has changed from 48!");
