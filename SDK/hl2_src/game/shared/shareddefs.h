...
#define COLOR_RED_FROLY Color(241, 130, 141, 255)
...
#define COLOR_PURPLE    Color(102, 51, 153, 1)
...
// EFFECTS
//-----------------------------------------------------------------------------
constexpr int FX_BLOODSPRAY_DROPS = 0x01;
constexpr int FX_BLOODSPRAY_GORE  = 0x02;
constexpr int FX_BLOODSPRAY_CLOUD = 0x04;
constexpr int FX_BLOODSPRAY_ALL   = 0xFF;
